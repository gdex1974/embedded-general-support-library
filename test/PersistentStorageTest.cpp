...
TEST(ESP32PersistentStorageTest, SetAndGetNewObject)
{
...
TEST(ESP32PersistentStorageTest, SetAndGetExistingObject)
{
    std::array<uint8_t, kBufferSize> buffer {};
    PersistentStorage storage { BytesView(buffer) };
...
TEST(ESP32PersistentStorageTest, SetNotEnoughSpace)
{
    constexpr int kSmallBufferSize = sizeof(NodeDescriptor) + sizeof(TestObj) - 1;
    std::array<uint8_t, kSmallBufferSize> buffer {};
    PersistentStorage storage { BytesView(buffer) };
...
TEST(ESP32PersistentStorageTest, GetNonExistingIndex)
{
    std::array<uint8_t, kBufferSize> buffer {};
    PersistentStorage storage { BytesView(buffer) };
...
TEST(ESP32PersistentStorageTest, GetWrongType)
{
    std::array<uint8_t, kBufferSize> buffer {};
    PersistentStorage storage { BytesView(buffer) };
...
TEST(ESP32PersistentStorageTest, GetSetTest)
{
    std::array<uint8_t, kBufferSize> buffer {};
    PersistentStorage storage { BytesView(buffer) };
...
//Test get() with wrong size:
TEST(ESP32PersistentStorageTest, SetWithExistingKey)
{
    std::array<uint8_t, kBufferSize> buffer {};
    PersistentStorage storage { BytesView(buffer) };
...
//Test get() with wrong size:
TEST(ESP32PersistentStorageTest, GetNotExistingKey)
{
    std::array<uint8_t, kBufferSize> buffer {};
    PersistentStorage storage { BytesView(buffer) };
...
//Test get() with wrong size:
TEST(ESP32PersistentStorageTest, Persistence)
{
    std::array<uint8_t, kBufferSize> buffer {};
